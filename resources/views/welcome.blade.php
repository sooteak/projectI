    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top">Southern Virtual Open Day</a>
...
<div class="alrazy-title" data-splitting style="margin:200px;">Welcome to Southern Virtual Open Day!</div>
<a href="login"><button class="btn btn-primary" type="submit" style="margin-left:550px;margin-top:0px">Get Start!</button></a>
