  ...
  <div class="faculty_list" >
    ...
    <div class="faculty">
        <div class="card">
            ...
            <div class="back" style="background-color: #afb8eb">
            <div class="faculty_image" ><img src="{{ asset('storage/' .$club->image) }}" width="220" height="146" /></div>
                <div class="faculty_name">
                    <div class="faculty_introduction" >Description:  {{$club->description}} </div>
                    <div class="members">Member: {{ $club->member }}</div>
                </div>
