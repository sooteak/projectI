...
<html>
    <body style="border-radius: 5px;background:#7979798f;margin-top:100px;padding:20px;margin-bottom: 100px;text-align:center;">
        ...
        <a href="/file/Freshmen Guide.pdf" download><button type="button">Freshmen Guide</button></a><hr>
        <a href="/file/Rules and Regulations of Student Societies.pdf" download><button type="button">Rules and Regulations od Student Societies</button></a><hr>
        <a href="/file/SUC Intro 2021" download><button type="button">SUC Intro 2021</button></a><hr>
        ...
        <a href="/file/SFS- School of Foundation Studies.pdf" download><button type="button">SFS-School of Foundation Studies</button></a><br>
