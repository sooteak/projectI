...
<html>
    <body style="border-radius: 5px;background:#7979798f;margin-top:100px;padding:20px;margin-bottom: 100px;text-align:center;">
        <h5><strong>Download Resources</strong></h5><br>
        <p><strong>SUC Intro</strong></p>
        <a href="/file/SUC Intro 2021.pdf" download><button type="button">SUC Intro 2021</button></a><hr>
        <p><strong>Fee</strong></p>
        <a href="/file/International Fees Structure.pdf" download><button type="button">International Fees Structure</button></a><br><hr>
        <p><strong>PTPTN</strong></p>
        <a href="/file/FEP -PTPTN Application.pdf" download><button type="button">PTPTN Application</button></a><br>
        ...
        <a href="/file/FEP -postgraduate brochures 2021 VERSION 2.pdf" download><button type="button">FEP- postgraduate brochures 2021</button></a><br>
        <a href="/file/FEP -SFS-School of Foundation Studies.pdf" download><button type="button">SFS-School of Foundation Studies</button></a><br>
        <a href="/file/FEP -Programme Guide 2021 VERSION 3.pdf" download><button type="button">All Programme Details 2021</button></a><hr>
        <p><strong>Insurance</strong></p>
        <a href="/file/FEP -Student Insurance (ENG).pdf" download><button type="button">Student Insurance (ENG)</button></a><br>
        <a href="/file/学生保险 (CN)" download><button type="button">Student Insurance 学生保险(CN)</button></a><hr>
        <p><strong>Scholarship</strong></p>
        <a href="/file/FEP -Scholarship Application Form.pdf" download><button type="button">Scholarship Application Form</button></a><br><hr>
